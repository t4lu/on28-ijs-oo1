...
São exemplos algumas como: Javascript e Python.
...
Suportam vários paradigmas de programação. Assim podemos utilizar cada paradigma para solucionar um problema da forma mais elegante e simples possível, conforme o seu objetivo. 
...
**Exemplos de linguagens multi-paradigmas:**
- Ruby
- Python
- JavaScript
- Swift
